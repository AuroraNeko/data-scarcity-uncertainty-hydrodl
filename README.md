...
> **Status:** Manuscript in preparation for HESS. Code released for
> reproducibility. Example result JSONs and figures are included; the 24 GB
> dataset and model checkpoints are regenerated by the scripts below.
...
A few descriptions in the paper Methods do not match the code (target transform,
dropout placement, batch size, early-stopping criterion, sequence length /
spin-up, basin sampling). These do not affect the conclusions. See
**[docs/PAPER_REVISION_NOTES.md](docs/PAPER_REVISION_NOTES.md)** for the
itemized list and suggested wording fixes.
...
China (72271091), the Open Cooperation Projects of the Henan Academy of
Sciences (220901008), and the Major Science and Technology Projects of the
Ministry of Water Resources (SKS-2022029). CAMELS-US is publicly available from
the NCAR/UCAR data archive.
